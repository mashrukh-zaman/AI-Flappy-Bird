...
path = "/home/tannur/Downloads/flappy bird/imgs"

BIRD_IMG = [pygame.transform.scale2x(pygame.image.load(os.path.join(path, "bird1.png"))), pygame.transform.scale2x(pygame.image.load(os.path.join(path, "bird2.png"))), pygame.transform.scale2x(pygame.image.load(os.path.join(path, "bird3.png")))]
